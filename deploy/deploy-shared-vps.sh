...
REMOTE_NGINX_FILE="/etc/nginx/conf.d/bfe-landing-page.conf"
LEGACY_REMOTE_NGINX_FILE="/etc/nginx/snippets/bfe-drive.local.d/bfe-landing-page.conf"
REMOTE_CERTBOT_HOOK="/etc/letsencrypt/renewal-hooks/deploy/30-bfe-landing-page-nginx"
